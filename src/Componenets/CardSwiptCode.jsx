...
const CardSwap = ({
  ...
  useEffect(() => {
    ...
    refs.forEach((r, i) => placeNow(r.current, makeSlot(i, cardDistance, verticalDistance, total), skewAmount, isMobile));
  ...
  return (
    <div
      ...
      scale-[0.9] sm:scale-[0.8] md:scale-[0.65] lg:scale-[0.8] xl:scale-108"
      style={{ width, height }}
    >
      {rendered}
    </div>
